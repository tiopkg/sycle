...
var deprecate = require('depd')('sycle:app');
...
Application.prototype.set = function(setting, val){
    ...
    if (arguments.length === 1) {
        val = dotty.get(this.settings, setting);
        if (val === undefined && target && (typeof target.set === 'function')) {
            val = target.set(setting);
        }
        return val;
    }
...
Application.prototype.ask = function (uri, params, payload) {
    return ask(this, uri, params, payload);
};

Application.prototype.request = deprecate.function(Application.prototype.ask, 'app.request: Use app.ask replace');
...
Application.prototype.enableAuth = function (options) {
    authorizer(this, options);
